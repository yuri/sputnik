    ...
    <body >
        <div class="container">
            <div id="header">
                ...
                <div id="search">
                    <a $site_rss_link>
                        <img src="$icons_url/feed-icon-12x12.png" class="rss_icon" title="RSS for edits to this wiki" alt="Small RSS Icon" />
                    </a>
                    $if_search[[
                        <form action="$base_url" style="margin-right: 0px; padding-right: 0px;">
                            ...
                            <button class="small_submit" type="button" name="Search"
                            title="_(TOOLTIP_FOR_SEARCH)">Go</button>
                        </form>
                    <br/>]]
                </div>
                <!-- end search -->
            ...
            <div id='page' $if_old_version[[style='background-color:#ddd;']]>
                ...
                <h1 class="title">
                    <a $show_link >$title</a>
                    $if_old_version[[<span class="from_version">($version)</span>]]
                </h1>
            ...
            <div id="footer">_(POWERED_BY_SPUTNIK)</div>
...
EDIT_FORM_HEADER        = [[<h3><a name="$anchor"></a>$label</h3>]]
EDIT_FORM_NOTE          = [[<h3>$label</h3>]]
EDIT_FORM_LABEL         = [[<label for="$name">$label</label>]]
EDIT_FORM_HONEYPOT      = [[<input type="text" class="textInput" value="$value" name="$name"/>]]
EDIT_FORM_TEXT_FIELD    = [[<input type="text" class="textInput" value="$value" name="$name" />]]
EDIT_FORM_READONLY_TEXT = [[<input type="text" class="textInput" value="$value" name="$name" class="readonly" readonly="readonly" />]]
EDIT_FORM_PASSWORD      = [[<input type="password" class="textInput" value="$value" name="$name" size="20"></input>]]
EDIT_FORM_TEXTAREA      = [[<textarea class="small_textarea" name="$name" rows="$rows">$value</textarea>]]
EDIT_FORM_BIG_TEXTAREA  = [[<textarea class="big_textarea" name="$name" id="main_text_area" rows="$rows" wrap="off">$value</textarea><a href="#" onclick="expandTextArea(); return false;">expand</a>]]
