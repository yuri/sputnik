...
of your server.  While there, you can also set the ``USE_NICE_URLS`` to ``true``
and edit the ``BASE_URL`` parameter to whatever you want to use as a base for your URLs.
E.g., if you set it to "/mysite/" your wikilinks will point to "/mysite/Page_Name".
(You will also need to configure the corresponding URL-rewriting rules for your server.)
